        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Link to='/cart'
                   className={`${darkMode?'text-dark-primary':'text-light-primary'} d-flex align-items-center myLink`}
              >
                <BiCart size='2rem' />
                {!isEmpty&&<span style={{position:'relative',left:'-21px',top:'-18px'}}>{totalItems}</span>}
                <span style={{marginLeft:!isEmpty?'-13px':'0px'}} className='cart'>Cart</span>
                </Link>
            </Nav>
          </Navbar.Collapse>
        </Container>
